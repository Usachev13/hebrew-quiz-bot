...
let PREVIEW_GENDER = null;

const SAY = [
  {id:"say:daily:0", ru:"Сколько это стоит?", he:"כַּמָּה זֶה עוֹלֶה?",
   reading:"кама зе оле?", audio:null, note:null},
  {id:"say:daily:1", ru:"У вас есть …?", he:"יֵשׁ לָכֶם …?",
   reading:"еш лахем?", audio:null, note:null},
  {id:"say:daily:3", ru:"Можно пакет?", he:"אֶפְשָׁר שַׂקִּית?",
   reading:"эфшар сакит?", audio:null, note:null},
  {id:"say:daily:9", ru:"Счёт, пожалуйста", he:"חֶשְׁבּוֹן, בְּבַקָּשָׁה",
   reading:"хешбон, бевакаша", audio:null,
   note:"В кафе так просят счёт."},
  {id:"say:meeting:2", ru:"Откуда ты?", he:"מֵאַיִן אַתָּה?",
   reading:"меайн ата?", audio:null,
   note:"Форма зависит от того, к кому обращаетесь, а не от вас.",
   to:{ m:{he:"מֵאַיִן אַתָּה?", reading:"меайн ата?", audio:null},
        f:{he:"מֵאַיִן אַתְּ?",  reading:"меайн ат?",  audio:null} }},
];
...
window.fetch = async (path, opt) => {
  ...
  if (path.endsWith("/menu")) r = {
    ...
    if ("gender" in b) PREVIEW_GENDER = b.gender;
  ...
  else if (path.endsWith("/situations")) r = { gender: PREVIEW_GENDER,
    situations: [
      {key:"daily", name:"Быт: макколет, рынок, кафе", total:12, seen:5, learned:2},
      {key:"office", name:"Учреждения: банк, битуах леуми, купат холим",
       total:12, seen:0, learned:0},
      {key:"home", name:"Жильё и бытовые службы", total:12, seen:0, learned:0},
      {key:"meeting", name:"Знакомство и разговор о себе",
       total:12, seen:3, learned:1}] };
