...
**Два формата.** Выбор из четырёх вариантов — узнавание; «⌨️ Написать
самому» — активное вспоминание, ответ набирается руками. Огласовки писать
не нужно, полное написание (חולצה при эталоне חֻלְצָה) принимается,
описка в одну букву засчитывается с показом верного написания.
В режиме набора: «?» — подсказка по буквам, `/skip` — пропустить.
