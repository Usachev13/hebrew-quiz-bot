...
- **Стиль:** клеймофизм (толстые границы, двойные тени, отскок при
  нажатии) поверх бенто-сетки. Первое лечит плоскость, второе —
  одинаковость плиток. Оба выбраны из выдачи скилла по запросу
  «educational app» и «modular cards».
